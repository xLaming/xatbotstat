...
class xatBotStat:
	...
	def getId(self):
		id = self.raw("What is your xat username: ")
		getUser = self.getSite("https://xat.me/web_gear/chat/profile.php?name=" + id)
		if not id.isalnum() or getUser[1] is "":
	...
	def getKey(self):
		...
		if key is None or len(key) != 16: #for now 16 is being generated
